...
@RequestMapping("/metaconfig/apidoc")
public class ApiDocParserController {

	private static final Logger LOG = LoggerFactory.getLogger(ApiDocParserController.class);
