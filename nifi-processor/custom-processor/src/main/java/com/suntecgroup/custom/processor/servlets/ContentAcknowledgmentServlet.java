...
public class ContentAcknowledgmentServlet extends HttpServlet {
    ...
    public void init(final ServletConfig config) throws ServletException {
        ...
        this.processor = (Processor) context.getAttribute(CustomListenHTTPProcessor.CONTEXT_ATTRIBUTE_PROCESSOR);
    ...
    protected void doDelete(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            session.transfer(flowFiles, CustomListenHTTPProcessor.RELATIONSHIP_SUCCESS);
            session.commit();
