...
import com.suntecgroup.custom.processor.servlets.ContentAcknowledgmentServlet;
import com.suntecgroup.custom.processor.servlets.ListenHTTPServlet;

/**
 * Starts an HTTP Server and listens on a given base path to transform incoming
 * requests into FlowFiles. It also supports OAuth client credentials based
 * authorization.
 * 
 * @author murugeshpd
 *
...
public class CustomListenHTTPProcessor extends AbstractSessionFactoryProcessor {

    private Set<Relationship> relationships;
    private List<PropertyDescriptor> properties;
    private OAuthIntrospectionService authIntrospectionService = new OAuthIntrospectionService();
    ...
    public static final String CONTEXT_ATTRIBUTE_OAUTH_SERVICE = "oAuthService";
    ...
    protected void init(final ProcessorInitializationContext context) {
        ...
        descriptors.addAll(authIntrospectionService.getProperties());
    ...
    private void createHttpServerFromService(final ProcessContext context) throws Exception {
        ...
        contextHandler.setAttribute(CONTEXT_ATTRIBUTE_OAUTH_SERVICE, authIntrospectionService);
