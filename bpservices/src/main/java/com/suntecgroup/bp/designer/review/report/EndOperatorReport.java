...
public class EndOperatorReport {

	private static final Logger LOGGER = LoggerFactory.getLogger(EndOperatorReport.class);

	/**
	 * This method will compare the end operator fields.
	 */
	public static List<Fields> endOperatorComparision(Operators sourceVersionOperator, Operators targetVersionOperator,
		...
		try {
			...
			LOGGER.error("End operator comparision error"+exception);
