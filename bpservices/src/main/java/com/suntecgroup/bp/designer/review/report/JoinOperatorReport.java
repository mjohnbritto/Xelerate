...
public class JoinOperatorReport {

	private static final Logger LOGGER = LoggerFactory.getLogger(JoinOperatorReport.class);

	/**
	 * This method will compare the join operator fields.
	 */
	public static List<Fields> joinOperatorComparision(Operators sourceVersionOperator, Operators targetVersionOperator,
